...
The BAM files (mapping data of the genomic reads) were filtered using a C program in source code file "filter_bam.cpp" (under folder "C code"). The compilation of the executable binary program requires the HTSLib. The usage of filter_bam is supplied with an example of shell script "process_bam.sh".
